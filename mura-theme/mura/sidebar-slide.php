...
<aside id="toggle-sidebar" class="mobile-navigation toggle-sidebar sidebar sidebar-2" aria-label="<?php esc_attr_e( 'Blog Sidebar', 'mura' ); ?>">
	<div class="toggle-sidebar-header">
		...
		$mobile_only = ( get_theme_mod( 'mura_sidebar_primary_nav', false ) ? '' : ' mobile-only' );
