<?php
/**
 * Mura: Customizer Colour Scheme Settings
 *
 * @package WordPress
 * @subpackage mura
 * @since 1.0
...
require( get_template_directory() . '/inc/customizer/sections/colors/widgets-footer.php' );
require( get_template_directory() . '/inc/customizer/sections/colors/widgets-toggle-sidebar.php' );
require( get_template_directory() . '/inc/customizer/sections/colors/widgets-between-posts.php' );
...
function mura_color_scheme_customize_register( $wp_customize ) {

		$wp_customize->add_panel( 'mura_color_settings', array(
	  'title' => esc_html__( 'Mura: Color Settings', 'mura' ),
	  'priority' => 140,
	  ) );

}

add_action( 'customize_register', 'mura_color_scheme_customize_register', 20 );