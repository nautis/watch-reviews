...
( function( $ ) {
    ...
    wp.customize( 'mura_archive_post_background', function( value ) {
    ...
    // Homepage Title
    wp.customize( 'mura_homepage_loop_title', function( value ) {
    ...
    // Homepage subtitle
    wp.customize( 'mura_homepage_loop_subtitle', function( value ) {
        value.bind( function( to ) {
    ...
    // Homepage columns
    wp.customize( 'mura_homepage_loop_cols', function( value ) {
        value.bind( function( newval ) {
            if ( '1' === newval ) {
    ...
    // Homepage post style
    wp.customize( 'mura_homepage_loop_style', function( value ) {
        value.bind( function( newval ) {
            if ( 'cover' === newval ) {
    ...
    wp.customize( 'mura_homepage_thumbnail_aspect_ratio', function( value ) {
        value.bind( function( newval ) {
            if ( 'wide' === newval ) {
    ...
    // Columns
    wp.customize( 'mura_archive_loop_cols', function( value ) {
        value.bind( function( newval ) {
            if ( '1' === newval ) {
    ...
    // Post style
    wp.customize( 'mura_archive_loop_style', function( value ) {
        value.bind( function( newval ) {
            if ( 'cover' === newval ) {
    ...
    wp.customize( 'mura_archive_thumbnail_aspect_ratio', function( value ) {
        value.bind( function( newval ) {
            if ( 'wide' === newval ) {
